...
import { FadeIn, PlaceholderImage, StarRating } from "../components";
            ...
            {isAuthenticated ? (
              <>
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={logout}
                  className="hidden md:flex border-slate-600 text-slate-300 hover:bg-slate-800 rounded-full px-5 text-sm"
                >
                  Logout
                </Button>
              </>
              ...
              <>
                <Link href="/auth/login">
                  <Button
                    size="sm"
                    variant="ghost"
                    className="hidden md:flex text-slate-300 hover:text-white rounded-full px-5 text-sm"
                  >
                    Login
                  </Button>
                </Link>
            ...
            >
              <div className="px-6 py-4 flex flex-col gap-4">
                ...
                {isAuthenticated ? (
                  <>
                    <Link href="/home">
                      <Button size="sm" className="bg-violet-600 hover:bg-violet-500 rounded-full w-full">
                        Go to Dashboard
                      </Button>
                    </Link>
                    <Button
                      ...
                      variant="outline"
                      onClick={logout}
                      className="border-slate-600 text-slate-300 hover:bg-slate-800 rounded-full w-full"
                    >
                      Logout
                    </Button>
                  </>
                  ...
                  <>
                    <Link href="/auth/login">
                      <Button size="sm" variant="ghost" className="text-slate-300 hover:text-white rounded-full w-full">
                        Login
                      </Button>
                    </Link>
                    <Link href="/auth/signup">
